...
const Signup= ()=>{
    ...
    const uploadPic = ()=>{
        ...
        data.append("upload_preset","farmstar")
        data.append("cloud_name","farmstar")
        fetch("https://api.cloudinary.com/v1_1/farmstar/image/upload",{
            method:"post",
            body:data
        })
        .then(res=>res.json())
    ...
    return (
       ...
       <p>
        <Link to="/Signin"><p style={{color:"black"}}>Already have an account,Signin</p></Link>
       </p>
      </div>
        </div>
